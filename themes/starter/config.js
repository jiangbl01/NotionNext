...
const CONFIG = {
  ...
  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: 'https://cdn.pixabay.com/photo/2017/01/20/00/30/maldives-1993704_960_720.jpg', // 产品预览图 ，默认读取public目录下图片
  ...
  // 嵌入外部表单
  STARTER_CONTACT_MSG_EXTERNAL_URL: 'https://amethyst-amusement-570.notion.site/FaHai-15cb1902d95f809d9927d79781fd1b93?pvs=4, // 基于NoteForm创建，将留言数据存在Notion中
  //   自定义留言表单，以下几个配置暂时废弃
